...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_tb', help='use TensorBoard to track logs (if passed)', action='store_true', default=True)
    ...
    * NOTE: case sensitive*
    ...
    parser.add_argument('--eval_metrics', help='metric(s) used for evaluation', type=str,
        choices=[
            'classwise', 'acc1', 'acc5', 'auroc', 'auprc', 'youdenj', 'f1', 'precision', 'recall',
